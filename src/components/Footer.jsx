            ...
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                <Typography
                  variant="small"
                  color="blue-gray"
                  className="mb-3 font-medium opacity-40 hover:text-blue-900 dark:text-white text-black"
                >
                  {title}
                </Typography>
                {items.map((link) => (
                  <li key={link}>
                    <Typography
                      ...
                      href="#"
                      color="gray"
                      className="py-1.5 font-normal transition-colors hover:text-blue-900 dark:text-white"
